...
impl RenderOnce for Link {
    fn render(self, _: &mut gpui::Window, cx: &mut gpui::App) -> impl IntoElement {
        ...
        div()
            ...
            .text_decoration_1()
            .text_decoration_color(cx.theme().accent.opacity(0.5))
            .hover(|this| {
                this.text_color(cx.theme().accent.opacity(0.8))
                    .text_decoration_1()
                    .text_decoration_color(cx.theme().accent)
            })
            .active(|this| {
                this.text_color(cx.theme().accent.opacity(0.6))
                    .text_decoration_1()
                    .text_decoration_color(cx.theme().accent)
            })
            .cursor_pointer()
